                                                            ...
                                                            <tbody>
                                                                                                ...
                                                                                                @foreach ($cart_array as $cart)
                                                                                                    <tr
                                                                                                        ...
                                                                                                        <th class="table-stack product-image-wrapper stack-column-center"
                                                                                                            ...
                                                                                                            <img width="140"
                                                                                                                class="product-image"
                                                                                                                src="uploads/product/{{ $cart['product_image'] }}"
                                                                                                                alt="Product Image"
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <th class="line-item-description"
                                                                                                                            ...
                                                                                                                            <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                                                                                                align="left">
                                                                                                                                <a href="https://us.tens.co/tools/emails/click/order-confirmation/1/product/link?url=https%3A%2F%2Fus.tens.co%2Fproducts%2Ftens-sunglasses%3Fvariant%3D123456789"
                                                                                                                                    target="_blank"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <th class="table-title"
                                                                                                        ...
                                                                                                        <span
                                                                                                            ...
                                                                                                            style="font-weight: bold;">Giảm
                                                                                                            giá</span>
                                                                                                        ({{ $order_code_array['coupon_code'] }})
                                                                                                    </th>
                                                                                                    <th class="table-text"
                                                                                                        style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                                                                        align="right"
                                                                                                        ...
                                                                                                        @if (isset($order_code_array['coupon_condition']) || isset($order_code_array['coupon_number']))
                                                                                                            @if ($order_code_array['coupon_condition'] == 1)
                                                                                                                @php
                                                                                                    ...
                                                                                                    <th class="billing_address "
                                                                                                        ...
                                                                                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                                                                            ...
                                                                                                            <a href="mailto:"
                                                                                                                ...
                                                                                                                target="_blank">{{ $shipping_array['shipping_email'] }}
                                                                                                            </a>
                                                                                                        </p>
                                                                                                    </th>
                                                                                                </tr>
                                                                ...
                                                                <tr id="section-1468276" class="section closing_text">
                                                                    <th data-key="1468276_closing_text" class="text"
                                                                        ...
                                                                        align="center" bgcolor="#ffffff">
                                                                        <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                                            align="center">Nếu bạn cần trợ giúp về bất
