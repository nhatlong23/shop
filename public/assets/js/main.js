...
function view() {
    ...
    if (Array.isArray(wishlist) && wishlist.length > 0) {
        ...
        for (var i = 0; i < wishlist.length; i++) {
            ...
            var row =
                '<div class="row" id="wishlist_' +
                id +
                '" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="' +
                image +
                '"></div><div class="col-md-8 info_wishlist"><p>' +
                name +
                '</p><p style="color:#FE980F">' +
                price +
                '</p><a href="' +
                url +
                '">Dat hang</a></div><button class="btn btn-danger" onclick="remove_wishlist(\'' +
                id +
...
$(".quickview").click(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#product_quickview_comment").html(data.product_comment);
            $("#product_quickview_sku").html(data.product_sku);
            $("#product_quickview_category").html(data.category_name);
            $("#product_quickview_brand").html(data.brand_name);
